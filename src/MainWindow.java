...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        grow = new javax.swing.JTextField();
        ...
        jLabel5.setText("Maximum growth percentage");

        grow.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                growActionPerformed(evt);
            }
        });
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        double distance, leafSize, trunkSize, growth;
        int quantity;

        try{
            distance = Double.parseDouble(dist.getText());
            leafSize = Double.parseDouble(leaf.getText());
            trunkSize = Double.parseDouble(trunk.getText());
            growth = Double.parseDouble(grow.getText());
            quantity = Integer.parseInt(amount.getText());

            Logic l = new Logic(distance, leafSize, trunkSize, growth, quantity);
        }
        catch(Exception e){
    ...
    private void growActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
    }
    ...
    private javax.swing.JTextField grow;
